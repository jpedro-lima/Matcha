...
type Profile struct {
	...
	PreferredGender pq.StringArray         `db:"preferred_gender" json:"preferred_gender"`
	...
	ProfilePhotos   pq.StringArray         `db:"profile_photos" json:"profile_photos"`
	FameRating      int                    `db:"fame_rating" json:"fame_rating"`
